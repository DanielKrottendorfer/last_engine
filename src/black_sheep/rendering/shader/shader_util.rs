...
pub static CANVAS_VS_SRC: &'static str = include_str!("./shader_res/canvas_image/vs.glsl");
pub static CANVAS_FS_SRC: &'static str = include_str!("./shader_res/canvas_image/fs.glsl");
